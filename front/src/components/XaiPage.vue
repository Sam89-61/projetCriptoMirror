...
const profils: Profil[] = [
  {
    ...
    themes: [
      ...
      { nom: 'Navigation Web', score: 29.2, max: 30, color: 'text-red-400', barColor: 'bg-red-500' },
    ...
    reponses_a_risque: [
      ...
      { theme: 'Navigation', question: 'Comment gérez-vous les cookies ?', reponse: 'Tout accepter', points: 7 },
      ...
      { theme: 'Email', question: 'Savez-vous reconnaître une tentative de phishing ?', reponse: 'Non', points: 8 },
    ...
    coherence: 'L\'IA cible tous les thèmes au score maximal ou quasi-maximal (MDP 40/40, Nav 29.2/30, Email 20/20, RS 10/10).',
  },
  {
    ...
    themes: [
      ...
      { nom: 'Navigation Web', score: 16.6, max: 30, color: 'text-orange-400', barColor: 'bg-orange-500' },
      { nom: 'Email / Phishing', score: 5, max: 20, color: 'text-emerald-400', barColor: 'bg-emerald-500' },
    ...
    coherence: 'L\'IA identifie les points forts (Email 5/20, RS 4/10) et cible les faiblesses réelles (MDP 20/40, Nav 16.6/30).',
  },
  {
    nom: 'Profil Expert',
    emoji: '🛡️',
    ...
    themes: [
      ...
      { nom: 'Navigation Web', score: 2.4, max: 30, color: 'text-emerald-400', barColor: 'bg-emerald-500' },
    ...
    coherence: 'L\'IA adopte un ton encourageant, ne cite que les 2 légères imperfections (Nav 2.4/30, RS 2/10), cohérent avec le score quasi nul.',
  },
]
...
const pointsXai = [
  {
    ...
    detail: 'Le ton et la sévérité des conseils varient directement en fonction du score global : alarmant pour 97/100, équilibré pour 46/100, bienveillant pour 4/100.',
  },
  {
